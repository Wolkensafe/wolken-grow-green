...
export function ConsultationDialog({ children }: ConsultationDialogProps) {
  ...
  setIsSubmitting(true);
    ...
    try {
      ...
      // Use your deployed Apps Script web‑app URL
      const GOOGLE_APPS_SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbw6ozeW45MK5NCQQCsGrykwYZRHrn4xqTJJaDMJCrJFjaCGr28hrn0aRF9Opi2vhsqW/exec";
